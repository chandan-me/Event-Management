...
function calculateBudget() {
    ...
    let eventCost =
        Number(document.getElementById("eventType").value);

    let catering =
        Number(document.getElementById("catering").value);

    let season =
        Number(document.getElementById("season").value);

    let slot =
        Number(document.getElementById("slot").value);
    ...
    // Ensure other fields also have valid numeric values
    ...
    let baseCost =
        venueCost + cateringCost;

    let total =
        baseCost * season * slot * duration;
    ...
    const discountRate = 0.08; // 8% discount
    ...
    breakdownEl.innerHTML =
        ...
        <div class="card mt-4 p-3">
            ...
            <p>
            Venue Cost : ₹ ${venueCost.toLocaleString()}
            </p>

            <p>
            Catering Cost : ₹ ${cateringCost.toLocaleString()}
            </p>
            ...
            <p>
            Discount (10%) : - ₹ ${discountAmount.toLocaleString()}
            </p>

            <h5>
            Final Budget : ₹ ${Math.round(discountedTotal).toLocaleString()}
            </h5>
    ...
    let scale =
        Math.min(100, Math.floor(guests / 5));
    ...
    if (guests < 50) {
        ...
        recommendation =
            "Perfect for a small and intimate gathering.";
        ...
        recommendation =
            "Large-scale event. Dedicated planning team recommended.";
...
alert(
"Thank you! Your event inquiry has been submitted."
);
